...
| 版本名称            | 测试起始时间 | 测试结束时间 |
| ------------------- | ------------ | ------------ |
| OpenHarmony 3.0.0.2 | 2021/8/4     | 2021/8/10    |

描述本次测试的测试环境（包括环境软硬件版本信息，环境组网配置信息, 测试辅助工具等）。

| 硬件型号       | 硬件配置信息 | 备注                                              |
| -------------- | ------------ | ------------------------------------------------- |
| park_pegasus   | Hi3861开发板 | docs/zh-cn/device-dev/quick-start/Hi3861开发板.md |
...
| 序号 | 特性名称    | 特性质量评估                             | 备注 |
| ---- | ----------- | ---------------------------------------- | ---- |
| *1*  | *分布式任务调度子系统* | *没有新增特性，轻设备拉起富设备FA，轻富免安装等基本功能可用测试通过，基本功能可用* |      |
| 2 | 内核子系统 | 没有新增特性，Issue问题测试通过，基本功能可用 | |
...
|  7  | 多媒体子系统 | 无新增特性，测试用例执行通过，特性质量良好 | |
|  8  | 启动恢复子系统 | 无新增特性，测试用例执行通过，特性质量良好 | |
|  9  | 数据管理子系统 | 没有新增特性，测试用例执行通过，特性质量良好 | |
...
| ------- | -------- | ------------ | ------------ | ---- |
| I3QEVG  |分布式任务调度子系统       |特性质量良好   |不涉及 |      |
|     I41HBB    |     【驱动子系统】基于HDF驱动框架提供mouse驱动能力     |        特性质量良好      |     不涉及         |      |
|         |          |              |              |      |
|         |          |              |              |      |
|         |          |              |              |      |
|         |          |              |              |      |
